...
// GDG brand color bars
const BRAND_COLORS = ["#4285f4", "#34a853", "#f9ab00", "#ea4335"];

export default function Footer() {
  const currentYear = new Date().getFullYear();

  return (
    <footer className="footer-section pt-16 pb-6">
      <div className="container">
        {/* Main footer grid */}
        <div className="grid gap-10 md:gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 mb-14">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(90deg, #4285f4, #34a853, #f9ab00, #ea4335)",
            opacity: 0.3,
          }}
        />
